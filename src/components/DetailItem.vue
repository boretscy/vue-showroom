                                    ...
                                    <div class="drop-container">
                                        <div class="drop-content">
                                            <div class="question-drop">
                                                Данная цена действительна в случае приобретения автомобиля клиентом при условии использования специальных программ Производителя и/или ДЦ, а именно:
                                                {{ getDiscountsName() }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="profit__head-discount__item">
                                    <div
                                            ...
                                            <div class="drop-container">
                                                <div class="drop-content">
                                                    <div class="question-drop">
                                                        Данная выгода действительна в случае приобретения автомобиля клиентом при условии использования специальных программ Производителя и/или ДЦ, а именно:
                                                        {{ getDiscountsName() }}
                                                    </div>
                                                </div>
                                            </div>
